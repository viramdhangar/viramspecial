        ...
        <div class="ct-u-displayTableVertical text-capitalize">
            ...
            <div class="ct-u-displayTableCell text-right">
                <span class="ct-u-textNormal ct-u-textItalic">
                    <a href="index.html">Fees</a> / <a href="#">Fees Details</a>
                </span>
            </div>
        </div>
    </div>
...
<section class="ct-u-paddingBoth100 ct-u-backgroundLightGreen">
    <div class="container">
        <div class="container">
            <div class="row">
            <c:forEach items="${feesDetailList}" var="feeDetail">    
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="ct-priceBox text-center">
                        <div class="ct-priceSection ct-priceBox-section">
                            <h5 class="ct-fw-400">Fee Detail</h5>
                            <div class="ct-priceBox-fullPrice">
                                <span class="ct-main-price ct-fw-700">${feeDetail.firstName} ${feeDetail.lastName}!</span>
                                <%-- <span class="ct-month">/ ${syllabus.requiredMonth}</span> --%>
                            </div>
                        </div>
                        <div class="ct-contentSection ct-priceBox-section">
                       	<%-- <c:forEach items="${syllabus.contentList}" var="content"> --%>
                            <span class="ct-fw-400"><span class="ct-fw-600"> Paid Fees </span>${feeDetail.totalPaidFees}</span>
                            <span class="ct-fw-400"><span class="ct-fw-600"> Remaining Fees </span>${feeDetail.totalRemainingFees}</span>
                            <span class="ct-fw-400"><span class="ct-fw-600"> Total Fees </span>${feeDetail.totalFees}</span>
                           <%--  </c:forEach> --%>
                        </div>
